            ...
            <div class="row">
              ...
              <div class="col-lg-8 entries">
                ...
                <article class="entry">
                  ...
                  <div class="entry-img">
                    <img src="../img/blog/01-1650532353.jpg" alt="" class="img-fluid">
                  </div>

                  <h2 class="entry-title">
                    <a href="../../views/blog-single.jsp">Da Lat brought to life in watercolor</a>
                  </h2>

                  <div class="entry-meta">
                    <ul>
                      <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a
                          href="../../views/blog-single.jsp">By Ha Thu, Nguyen Thanh Sang</a></li>
                      <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                          href="../../views/blog-single.jsp"><time datetime="2022-08-22">April 22, 2022</time></a></li>
                  ...
                  <div class="entry-content">
                    <p>
                      An artist from Da Lat depicts the beauty of his hometown, famous for its misty landscapes and
                      green pine forests, through watercolor paintings.
                    </p>
                    <div class="read-more">
                      <a href="../../views/blog-single.jsp">Read More</a>
                    </div>
                  </div>
                ...
                <article class="entry">
                  ...
                  <h2 class="entry-title">
                    <a href="../../views/blog-single-1.jsp">Sau Village a rare vestige of rural charms</a>
                  </h2>
                  ...
                  <div class="entry-content">
                    <p>
                      ...
                      molestias laboriosam. Tempora nam odit omnis eum corrupti qui aliquid excepturi molestiae. Facilis
                      et sint quos sed voluptas. Maxime sed tempore enim omnis non alias odio quos distinctio.
                    </p>
                    <div class="read-more">
                      <a href="../../views/blog-single.jsp">Read More</a>
                    </div>
              ...
              <div class="col-lg-4">
                ...
                <ul>
                  ...
                  <!--                   <h4><a href="../../views/blog-single.jsp">Nihil blanditiis at in nihil autem</a></h4> -->
                  <!--                   <time datetime="2020-01-01">Jan 1, 2020</time> -->
                  <!--                 </div> -->

                  <!--                 <div class="post-item clearfix"> -->
                  <!--                   <img src="../img/blog/blog-recent-2.jpg" alt=""> -->
                  <!--                   <h4><a href="../../views/blog-single.jsp">Quidem autem et impedit</a></h4> -->
                  <!--                   <time datetime="2020-01-01">Jan 1, 2020</time> -->
                  <!--                 </div> -->

                  <!--                 <div class="post-item clearfix"> -->
                  <!--                   <img src="../img/blog/blog-recent-3.jpg" alt=""> -->
                  <!--                   <h4><a href="../../views/blog-single.jsp">Id quia et et ut maxime similique occaecati ut</a></h4> -->
                  <!--                   <time datetime="2020-01-01">Jan 1, 2020</time> -->
                  <!--                 </div> -->

                  <!--                 <div class="post-item clearfix"> -->
                  <!--                   <img src="../img/blog/blog-recent-4.jpg" alt=""> -->
                  <!--                   <h4><a href="../../views/blog-single.jsp">Laborum corporis quo dara net para</a></h4> -->
                  <!--                   <time datetime="2020-01-01">Jan 1, 2020</time> -->
                  <!--                 </div> -->

                  <!--                 <div class="post-item clearfix"> -->
                  <!--                   <img src="../img/blog/blog-recent-5.jpg" alt=""> -->
                  <!--                   <h4><a href="../../views/blog-single.jsp">Et dolores corrupti quae illo quod dolor</a></h4> -->
                  <!--                   <time datetime="2020-01-01">Jan 1, 2020</time> -->
                  <!--                 </div> -->
