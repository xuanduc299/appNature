  ...
  ======================================================== -->
        ...
        <body>
            ...
            <header id="header" class="fixed-top d-flex align-items-center">
                <div class="container d-flex align-items-center">
                    ...
                    <nav id="navbar" class="navbar">
                        <ul>
                            <li><a href="../../views/home.jsp" class="active">Home</a></li>
            ...
            <article class="all-browsers"
                style="text-align: center;padding: 26px;margin: 20px;font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                <h1 style="color: rgb(0, 0, 0);">Nature app is Website talk about nature</h1>
                <h5>Let’s explore, relax, and play.</h5>
                <h5>Choose from 5 beach holiday destinations in Vietnam: Phu Quoc, Danang, Quang Nam, Khanh Hoa, and
                    Quang
                    Ninh.</h5>
                <h5>And best of all, it’s quarantine-free for the fully vaccinated. You are free to enjoy full holiday
                    access
                    upon arrival.</h5>
                <br>
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item active" style="background-image: url(../img/slide/15p.jpg)">
                            <div class="carousel-container">
                                <div class="container">
                                    <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Nature
                                            page</span></h2>
                                    <p class="animate__animated animate__fadeInUp">Ut velit est quam dolor ad a aliquid
                                        ...
                                        Similique ea
                                        voluptatem.
                                        Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi
                                        architecto.</p>
                                    <a href="#about"
                    ...
                    <div class="container">
                        ...
                        <div class="row content">
                            <div class="col-lg-6">
                                ...
                                <h3>Read the country information page for additional information on travel to Vietnam.
                                </h3>
                            </div>
                            <div class="col-lg-6 pt-4 pt-lg-0">
                                <p>
                                    The Centers for Disease Control and Prevention (CDC) has determined Vietnam has a
                                    high level of
                                    COVID-19. Visit the CDC page for the latest Travel Health Information related to
                                    your travel.
                                </p>
                                <ul>
                                    <li><i class="ri-check-double-line"></i> Read the Department of State’s COVID-19
                                        page before planning
                                        any international travel, and read the Embassy’s COVID-19 page for
                                        country-specific COVID-19
                                        information.</li>
                                    <li><i class="ri-check-double-line"></i> Enroll in the Smart Traveler Enrollment
                                        Program (STEP) to
                                        receive Alerts and make it easier to locate you in an emergency.</li>
                                    <li><i class="ri-check-double-line"></i> Follow the Department of State
                                        on Facebook and Twitter. </li>
                                    <li><i class="ri-check-double-line"></i> Review the Country Security Report for
                                        Vietnam.     </li>
                                    <li><i class="ri-check-double-line"></i> Prepare a contingency plan for emergency
                                        situations. Review
                                ...
                                <div class="portfolio-wrap">
                                    ...
                                    <div class="portfolio-info">
                                        ...
                                        <div class="portfolio-links">
                                            ...
                                            <a href="../../views/portfolio-details.jsp"
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                                <div class="portfolio-wrap">
                                    ...
                                    <div class="portfolio-info">
                                        ...
                                        <p>Web</p>
                                        <div class="portfolio-links">
                                            <a href="../img/portfolio/cap-02.jpg" data-gallery="portfolioGallery"
                                                class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
                                            <a href="../../views/portfolio-details-02.jsp"
                                                class="portfolio-details-lightbox" data-glightbox="type: external"
                                                title="Portfolio Details"><i class="bx bx-link"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                    ...
                                    <div class="portfolio-info">
                                        ...
                                        <p>App</p>
                                        <div class="portfolio-links">
                                            <a href="../img/portfolio/tent-01.jpg" data-gallery="portfolioGallery"
                                                class="portfolio-lightbox" title="App 2"><i class="bx bx-plus"></i></a>
                                            <a href="../../views/portfolio-details-03.jsp"
                                                class="portfolio-details-lightbox" data-glightbox="type: external"
                                                title="Portfolio Details"><i class="bx bx-link"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio-wrap">
                                    ...
                                    <div class="portfolio-info">
                                        ...
                                        <div class="portfolio-links">
                                            ...
                                            <a href="../../views/portfolio-details-01.jsp"
                                                class="portfolio-details-lightbox" data-glightbox="type: external"
                                                title="Portfolio Details"><i class="bx bx-link"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio-wrap">
                                    ...
                                    <div class="portfolio-info">
                                        ...
                                        <div class="portfolio-links">
                                            ...
                                            <a href="../../views/portfolio-details-05.jsp"
                                                class="portfolio-details-lightbox" data-glightbox="type: external"
                                                title="Portfolio Details"><i class="bx bx-link"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio-wrap">
                                    ...
                                    <div class="portfolio-info">
                                        ...
                                        <div class="portfolio-links">
                                            ...
                                            <a href="../../views/portfolio-details-07.jsp"
                                                class="portfolio-details-lightbox" data-glightbox="type: external"
                                                title="Portfolio Details"><i class="bx bx-link"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio-wrap">
                                    ...
                                    <div class="portfolio-info">
                                        ...
                                        <div class="portfolio-links">
                                            ...
                                            <a href="../../views/portfolio-details-06.jsp"
                                                class="portfolio-details-lightbox" data-glightbox="type: external"
                                                title="Portfolio Details"><i class="bx bx-link"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                                <div class="portfolio-wrap">
                                    ...
                                    <div class="portfolio-info">
                                        ...
                                        <p>Card</p>
                                        <div class="portfolio-links">
                                            <a href="../img/portfolio/water-bottle-01.jpg"
                                                data-gallery="portfolioGallery" class="portfolio-lightbox"
                                                title="Card 3"><i class="bx bx-plus"></i></a>
                                            <a href="../../views/portfolio-details-04.jsp"
                                                class="portfolio-details-lightbox" data-glightbox="type: external"
                                                title="Portfolio Details"><i class="bx bx-link"></i></a>
                                        </div>
                                    </div>
