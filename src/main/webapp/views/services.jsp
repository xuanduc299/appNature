        ...
        <div class="container d-flex align-items-center">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a href="../../views/services.jsp" class="active">Services</a></li>
      ...
      <main id="main">
        ...
        <section id="breadcrumbs" class="breadcrumbs">
          <div class="container">
            ...
            <p>The definition of service is “any intangible product, which is essentially a transaction and is
              transferred from the buyer to the seller in exchange for some consideration (or no consideration). Let us
              take a look at some of the characteristics of a service.</p>
            <ul>
              <li>Intangibility: A service is not a physical product that you can touch or see. A service can be
                experienced by the buyer or the receiver. Also, you can not judge the quality of the service before
                consumption.</li>
              <li>Inconsistency: There can be no perfect standardization of services. Even if the service provider
                remains the same, the quality of the service may differ from time to time.</li>
              <li>Inseparability: One unique characteristic of services is that the service and the service provider
                cannot be separated. Unlike with goods/products the manufacturing and the consumption of services cannot
                be separated by storage.</li>
              <li>Storage: The production and consumption of services are not inseparable because storage of services is
                not possible. Being an intangible transaction there can never be an inventory of services.</li>
            </ul>
            <img class="bn-service" src="../img/BusinessServices3.png" alt="Girl in a jacket"
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="icon-box">
                  ...
                  <h4><a href="#">1.Food Service</a></h4>
                  <p>Foodservice outlets are facilities that serve meals and snacks for immediate consumption on site
                    (food away from home).
                    Commercial foodservice establishments accounted for the bulk of food-away-from-home expenditures.
                    This category includes full-service restaurants, fast food outlets, caterers, some cafeterias, and
                    other places that prepare, serve, and sell food to the general public for a profit.
              ...
              <div class="col-md-6 mt-4 mt-md-0">
                <div class="icon-box">
                  ...
                  <h4><a href="#">2. Shopping service</a></h4>
                  <p>Our Shopping Service aims to support those people who are still struggling to do their own
                    shopping, have no one else nearby to help and cannot do an online shop</p>
                  <br>
                  <br>
                  <br>
                </div>
              ...
              <div class="col-md-6 mt-4 mt-md-0">
                <div class="icon-box">
                  ...
                  <h4><a href="#">3. Sports services.</a></h4>
                  <p>Sport industry is an industry in which people, activities, business, and organizations are involved
                    ...
                    buyers are sports related and may be goods, services, people, places, or ideas.</p>
                </div>
              </div>
              <div class="col-md-6 mt-4 mt-md-0">
                <div class="icon-box">
                  <i class="bi bi-binoculars"></i>
                  <h4><a href="#">4. Entertainment and entertainment services</a></h4>
              ...
              <div class="col-md-6 mt-4 mt-md-0">
                <div class="icon-box">
                  ...
                  <h4><a href="#">5. Health care services</a></h4>
              ...
              <div class="col-md-6 mt-4 mt-md-0">
                <div class="icon-box">
                  ...
                  <h4><a href="#">6. Other related services for tourists</a></h4>
