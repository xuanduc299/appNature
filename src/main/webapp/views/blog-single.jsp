              ...
              <div class="col-lg-8 entries">
                ...
                <article class="entry entry-single">
                  ...
                  <h2 class="entry-title">
                    <a href="blog-single.html">Da Lat brought to life in watercolor</a>
                  </h2>
                  ...
                  <div class="entry-content">
                    ...
                    <img src="../img/blog/02-1650532360.jpg" class="img-fluid" alt="">

                    <p>
                      Langbiang mountain peak is shrouded in mist.<br> <br>

                      Located around 12 kilometers to the north of downtown Da Lat, Langbiang Plateau was popularized by
                      French biologist Alexandre Yersin in 1893. Lying 1,400 meters above sea level,
                      the plateau is surrounded by high mountains, green pine forests and fresh air, making it an ideal
                      habitat for rare birds.<br> <br>

                      He always wakes up at 3 a.m., rides a motorbike to the foot of the mountain and then walks to the
                      top by nearly 5 a.m.<br> <br>

                      Up to now, he has painted about 100 works about people and nature in this highland town.<br>
                    </p>
